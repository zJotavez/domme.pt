...
(1, 'CCTV / Videovigilância', 'cctv-videovigilancia', 'Sistemas de videovigilância para residências, empresas, condomínios e espaços comerciais, com câmaras profissionais, gravação, monitorização e acesso remoto.', 'Camera', 'images/cctv-1.png', 'videos/video4.mp4', 1, 1),
(2, 'Intrusão / Sistemas de Alarme', 'intrusao-sistemas-alarme', 'Soluções de alarme contra intrusão com sensores, centrais, sirenes e tecnologia integrada para proteger pessoas e património.', 'ShieldAlert', 'images/alarme-intrusao-1.png', NULL, 1, 2),
(3, 'Controlo de Acessos', 'controlo-de-acessos', 'Sistemas para gestão de entradas e saídas, incluindo teclados, cartões, biometria, reconhecimento, leitores e permissões personalizadas.', 'Fingerprint', 'images/controlo-acessos-1.png', NULL, 1, 3),
...
'Garanta a Proteção do Seu Património', 'Fale connosco hoje para projetarmos um sistema de videovigilância sob medida para a sua residência ou empresa.', 'CCTV e Videovigilância Profissional | Cotton Dome LDA', 'Soluções profissionais de CCTV e videovigilância para residências, empresas e condomínios. Instalação, gravação, monitorização e acesso remoto.', 'CCTV, videovigilância, câmeras de segurança, câmeras IP, gravação de imagem, segurança eletrónica, Portugal'),
